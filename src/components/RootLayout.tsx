...
function NavigationItem({
  ...
  return (
    <Link
      ...
      className="group relative isolate -mx-5 bg-neutral-950 px-5 py-8 even:mt-px sm:mx-0 sm:px-0 sm:py-16 sm:odd:pr-16 sm:even:mt-0 sm:even:border-l sm:even:border-neutral-800 sm:even:pl-16"
    >
      {children}
