...
const navigation = [
  ...
  },
  {
    title: 'Services',
    links: [
      { title: 'SPAs & Web Apps', href: '/process' },
      { title: 'Landing Pages', href: '/process' },
      { title: 'Dashboards', href: '/process' },
      { title: 'CMS Integration', href: '/process' },
    ],
  },
  {
    title: 'Company',
      ...
      <FadeIn>
        ...
        <div className="mt-24 mb-20 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
          ...
          <p className="text-sm text-neutral-700">
            © Couto Software House {new Date().getFullYear()}
          </p>
        </div>
      </FadeIn>
    </Container>
