...
export default async function Blog() {
  ...
  return (
    <RootLayout>
      <PageIntro eyebrow="Blog" title="Insights and engineering updates">
        <p>
          Technical articles on web performance, frontend architecture, and
          modern development practices from our engineering team.
        </p>
      </PageIntro>
